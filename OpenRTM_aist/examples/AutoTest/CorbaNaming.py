...
class CorbaNaming:
  ...
  # @if jp
  #
  # @brief κδΌµκεΌµκδΌ»κε°κ¨«κδΌ±κδΌΑ
  #
  # @param self
  # @param orb ORB
  ...
  # @exception InvalidName ςςΊξ³ν name_list κγΈλξΈΊοξ­Ό¥
  ...
  #
  # @return €«Ό¥ψµΌΌκγΚκ¥ψηβΰκ¦¬κεΜκ¦ΊκδΌ©κδΌ±κε°ξΏδοιξ§
  #
  # @exception NotFound ρΰΘζΈ­εα® <c_1, c_2, ..., c_(n-1)> εαΈη­ΠηΨªεαΞεΆ¬εα¨ε€‚
  # @exception CannotProceed θΏΚε£ιεα¶εΆ°νπ¬ιΘ³εα§ιη¦νπ¬ε£ςξΈÒι¶ΤεΆ©εαΊεΆ¬εα¨ε€‚
  # @exception InvalidName κΎΚθΚ² name εα®ιπΊη±νεαΈζΈΊθ­£εΰ‚
  ...
  ##
  # @if jp
  # @brief κγÒκ¤»κγΌ¨κγΌ° Binding κδΔξ³τσ‘ξ¤κγÒκ¥λ
  #
  ...
  #
  # @param self
  # @param name_cxt Binding ςρΜνξΎΞνξ―Όΐ€µΌ£ NamingContext
  ...
  #
  # @param self
  # @param name_list τ¨²πΏ–μ±Όΐ€µΌ£ NameComponent
  #
  ...
  #
  # @return NameComponent τ¨²πΏ–π·ΐπέό
  #
  ...
  #
  # @param self
  # @param addr τ¨²πΏ–μ±Όΐ€µΌ£κδΌ¤κε²κ¨®κδΌ»
  # @param string_name τ¨²πΏ–μ±Όΐ€µΌ£ςςΊρξ§Ό²
  #
  # @return URL τ¨²πΏ–π·ΐπέό
  #
  ...
  #
  # @param self
  # @param name_list ςκΌ¦ςκΌ§τ³Όΐ€µΌ£
  #
  # @return ιθ¤ιθ¥ξ·ΐθΫό(εγΊε¦Ύεγήε¦µεβ°εβ³εγ³εγ¬ε¤―εβΉεγ:trueεΰΆε΅ύεβΈζ»¥κ¦–:false)
  #
  # @else
  ...
  #
  # @param self
  # @param name_list ςρΜνξΎΞνξ―Όΐ€µΌ£NameComponent
  ...
  #   Nc[0]id.Nc[0].kind/Nc[1]id.Nc[1].kind/Nc[2].id/Nc[2].kindκεΌ½κεΌ½κεΌ½
  # εα¨εα¨ε΅ζκΏΆκΎΎεΆ©ιοΜηΎΞεΆ©εαΊε£λεΰ‚
  #
  # @param self
  # @param name_list ςρΜνξΎΞνξ―Όΐ€µΌ£NameComponent
